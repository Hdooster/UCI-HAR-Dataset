...
===============
The dataset is cleaned up through processes described in the codebook included in this repository.

These processes are made and commented in the file run_analysis.R.
Included in the script is the loading of the 'plyr' package.
